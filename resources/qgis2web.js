...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1016789.042382, 5697108.252973, 1027777.457983, 5706459.676378], maxZoom: 20, minZoom: 13
    })
});
...
map.getView().fit([1016789.042382, 5697108.252973, 1027777.457983, 5706459.676378], map.getSize());
